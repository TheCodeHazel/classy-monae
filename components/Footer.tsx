...
const Footer = ({client_data}:{client_data:TClientData} ) => {
    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Company info */}
          <div>
            <h3 className="text-2xl font-serif font-bold mb-6">{client_data.logo_alt}</h3>
            <p className="text-gray-400 mb-6">
              Creating unforgettable experiences for all occasions. Your vision, our expertise.
            </p>
            ...
            <form className="space-y-4">
              <div className="flex">
                <input
                  ...
                  className="px-4 py-2 bg-gray-800 text-white rounded-l-md w-full focus:outline-none focus:ring-2 focus:ring-event-purple"
                />
                <button
                  type="submit"
                  className="bg-event-purple hover:bg-event-purple-dark px-4 py-2 rounded-r-md transition-colors"
                >
                  Subscribe
                </button>
              </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <p className="text-center text-gray-500">
            &copy; {currentYear} {client_data.logo_alt}. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
